# epublib
This project is a fork of Paul Siegmann's epublib library. It was forked on 7/14/2015
from source archive psiegman-epublib-1b40382.zip, which represents epublib version 3.1.
We therefore start versioning at 3.1.1. -- NT
